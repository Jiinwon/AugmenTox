# Script to aggregate statistical test results from model/statistics/results
...
if __name__ == '__main__':
    ...
    write_csv(rows, './statistics/summary.csv')
    try:
        write_xlsx(rows, './statistics/summary.xlsx')
