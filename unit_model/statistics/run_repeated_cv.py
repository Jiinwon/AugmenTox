...
def main():
    ...
    parser.add_argument('--val-idx-dir', required=True, help='검증 인덱스 및 결과 저장 디렉토리')  # 수정필요
    parser.add_argument('--repeats', type=int, default=10, help='반복 횟수')
    parser.add_argument('--folds', type=int, default=5, help='폴드 수')
    parser.add_argument('--batch_size', type=int, default=getattr(cfg, 'BATCH_SIZE', 32), help='배치 크기')  # 수정필요: cfg에 정의 여부 확인
